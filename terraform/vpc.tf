...
# Private Subnets (EKS Core/Workers)
...
resource "aws_subnet" "cache" {
  ...
  tags = {
    Name = "${var.cluster_name}-cache-${count.index}"
  }
}

# NAT Gateways & EIPs for Private Subnets routing
...
resource "aws_route_table_association" "database" {
  ...
  route_table_id = aws_route_table.private.id # Private routing
}
